 ...
 *         24.07.2017.
 */
public class AddLocalizedMovieInfoCommand implements Command {
    private final static Logger logger = Logger.getLogger(AddLocalizedMovieInfoCommand.class);
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            boolean isAdded =
                    movieService.addLocalizedMovieInfo(movieId, contentLanguage,
                            movieName, description, slogan);
        } catch (ServiceException e) {
            logger.error("Error during executing AddLocalizedMovieInfoCommand", e);
