...
public class DeleteGenreForMovieCommand implements Command {
    private final static Logger logger = Logger.getLogger(DeleteGenreForMovieCommand.class);
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            boolean isDeleted = movieService.deleteGenreForMovie(movieId, genreId);
        } catch (ServiceException e) {

            logger.error("Error during executing DeleteGenreForMovieCommand", e);
