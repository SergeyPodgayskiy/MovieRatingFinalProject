 ...
 *         26.07.2017.
 */
public class UpdateLangDependentMovieInfoCommand implements Command {
    private static final Logger logger = Logger.getLogger(UpdateLangDependentMovieInfoCommand.class);
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            boolean isUpdated =
                    movieService.updateLangDependentMovieInfo(movieId, contentLanguage,
            ...
            logger.error("Error during executing updateLangDependentMovieInfo", e);
