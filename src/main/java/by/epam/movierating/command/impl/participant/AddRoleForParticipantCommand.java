 ...
 *         31.07.2017.
 */
public class AddRoleForParticipantCommand implements Command {
    private final static Logger logger = Logger.getLogger(AddRoleForParticipantCommand.class);
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            boolean isAdded = participantService.addRoleForParticipant(participantId, roleId);
        } catch (ServiceException e) {
            logger.error("Error during executing AddRoleForParticipantCommand", e);
