 ...
 *         27.07.2017.
 */
public class GetParticipantsInMovieCommand implements Command {
    private final static Logger logger = Logger.getLogger(GetParticipantsInMovieCommand.class);
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            List<MovieParticipant> participantList =
                    movieParticipantService.getParticipantsInMovieByRole(movieId, roleId, currentLanguage);
            ...
            logger.error("Error during executing GetParticipantsInMovieCommand", e);
