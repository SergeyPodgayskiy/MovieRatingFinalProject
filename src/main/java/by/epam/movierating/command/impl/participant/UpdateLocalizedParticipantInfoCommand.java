 ...
 *         31.07.2017.
 */
public class UpdateLocalizedParticipantInfoCommand implements Command {
    private static final Logger logger = Logger.getLogger(UpdateLocalizedParticipantInfoCommand.class);
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            boolean isUpdated =
                    participantService.updateLocalizedParticipantInfo(participantId, contentLanguage,
                            name, surname);
            ...
            logger.error("Error during executing UpdateLocalizedParticipantInfoCommand", e);
