 ...
 *         06.07.2017.
 */
public class UpdateMovieRatingCommand implements Command {
    private static final Logger logger = Logger.getLogger(UpdateMovieRatingCommand.class);
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            boolean isUpdatedRating = ratingService.updateMovieRating(idMovie,idUser,mark); //todo
