...
<div class="nav-side-menu">
    ...
    <div class="menu-list">
        <ul id="menu-content" class="menu-content collapse out">
            <li class="target">
                <a href="Controller?command=show-statistic"><i class="fa fa-bar-chart fa-fw"></i>
                    <fmt:message bundle="${loc}" key="statistic"/> <%--<span class="arrow"></span>--%>
                </a>
            </li>
            <li class="target">
                <a href="Controller?command=show-users"><i class="fa fa-users fa-fw"></i>
                    <fmt:message bundle="${loc}" key="users"/> <%--<span class="arrow"></span>--%>
                </a>
            </li>
            <li class="target">
                <a href="Controller?command=redirect&redirectPage=addMoviePage&previousPageQuery=${pageContext.request.queryString}"><i class="fa fa-film fa-fw"></i>
