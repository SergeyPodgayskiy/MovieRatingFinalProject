...
!function (e) {
    ...
    var t, a;
    t = {
        NAMESPACE: ".rating", DEFAULT_MIN: 0, DEFAULT_MAX: 10, DEFAULT_STEP: .5, isEmpty: function (t, a) {
        ...
        constructor: a, _parseAttr: function (e, a) {
            ...
            return n.options = t, e.each(t, function (e, t) {
                n[e] = t
            }), (n.rtl || "rtl" === r.attr("dir")) && (n.rtl = !0, r.attr("dir", "rtl")), n.starClicked = !1, n.clearClicked = !1, n._initSlider(t), n._checkDisabled(), n.displayOnly && (n.inactive = !0, n.showClear = !1, n.showCaption = !0), n._generateRating(), n._initEvents(), n._listen(), a = n._parseValue(r.val()), r.val(a), r.removeClass("rating-loading")
